...
<td><a type="button" href="../vista/raza/edit?id=<?php echo $va["id_raza"]; ?>"  class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
                ...
                <a type="button" onclick="return confirm('Estás seguro que deseas eliminar el registro?');"href="../vista/raza/borrar?id=<?php echo $va["id_raza"]; ?>"  class="btn bg-red btn-circle waves-effect waves-circle waves-float">
