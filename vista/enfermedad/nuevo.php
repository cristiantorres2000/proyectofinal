            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                REGISTRO DE ENFERMEDAD DE MASCOTAS
                    ...
                    <div class="body">
                        <form method="POST"  autocomplete="off" enctype="multipart/form-data">
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <label class="control-label">Nombre de la ENFERMEDAD<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nombreenfermedad" required class="form-control" placeholder="Nombre de la raza de mascota..." />
                                        </div>
                                    </div>
                                </div>
...
$sql = "select * from enfermedad where nombreenfermedad='$nombreenfermedad'";
...
$sql2 = "insert into enfermedad(nombreenfermedad) 
...
swal("¡Registrado!", "Agregado correctamente", "success").then(function() {
            window.location = "../../folder/enfermedad";
        });
        </script>
