...
$con = connect();
$id = $_GET['id'];
$sql = "SELECT * FROM enfermedad  WHERE idenfermedad= '$id'";
$query  =$con->query($sql);
$data =  array();
if($query){
...
<?php if(count($data)>0):?>
    <?php foreach($data as $d):?>
                        <form method="POST"  autocomplete="off" action="editarRegistro?id=<?php echo $d->idenfermedad; ?>">
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <label class="control-label">Nombre de la enfermedad</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nombreenfermedad" value="<?php echo $d->nombreenfermedad; ?>"  class="form-control" placeholder="Nombre del tipo..." />
                                        </div>
                                    </div>
                                </div>
                            </div>
