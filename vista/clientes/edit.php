                        ...
                        <form method="POST"  autocomplete="off" action="editarRegistro?id=<?php echo $d->id_due; ?>">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                        <input type="text" value="<?php echo $d->digito_ver; ?>" name="digito_ver"  maxlength="1" required class="form-control" placeholder="DNI del cliente..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                        <input type="text" value="<?php echo $d->correo; ?>" name="correo"  required class="form-control" placeholder="DNI del cliente..." />
                                        </div>
                                    </div>
                                </div>
