...
<!--=============================================================CONTENIDO DE LA PÁGINA =============================================================-->
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Listado de clientes : 
                            </h2><br> <a type="button" href="../vista/clientes/nuevo" class="btn bg-light-green waves-effect">
                                <span>NUEVO</span>
            ...
            <td><?php echo $va['dni_due'];?>&nbsp;<?php echo '-';?>&nbsp;<?php echo $va['digito_ver'];?></td>
...
<td><a type="button" href="../vista/clientes/edit?id=<?php echo $va["id_due"]; ?>"  class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
                ...
                <a type="button" onclick="return confirm('Estás seguro que deseas eliminar el registro?');"href="../vista/clientes/borrar?id=<?php echo $va["id_due"]; ?>"  class="btn bg-red btn-circle waves-effect waves-circle waves-float">
