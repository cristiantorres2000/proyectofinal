                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="body">
                        <form method="POST"  autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <label class="control-label">Digito verificador<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="digito_ver"  maxlength="1" required class="form-control" placeholder="DNI del cliente..." />
                                        </div>
                                    </div>
                                </div>
...
$sql2 = "insert into owner(dni_due,digito_ver,nom_due,ape_due,movil,correo,direc,estado) 
values ('$dni_due','$digito_ver','$nom_due','$ape_due','$movil','$correo','$direc','$estado')";
