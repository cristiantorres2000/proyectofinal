...
<td><a type="button" href="../vista/tipo/edit?id=<?php echo $va["id_tiM"]; ?>"  class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
                ...
                <a type="button" onclick="return confirm('Estás seguro que deseas eliminar el registro?');" href="../vista/tipo/borrar?id=<?php echo $va["id_tiM"]; ?>"  class="btn bg-red btn-circle waves-effect waves-circle waves-float">
