            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <h2>
                                Listado de mascotas : 
                            </h2><br> <a type="button" href="../vista/mascotas/nuevo" class="btn bg-light-green waves-effect">
                                <span>NUEVO</span>
...
<td><a type="button" href="../vista/mascotas/edit?id=<?php echo $va["id_pet"]; ?>"  class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
                ...
                <a type="button" onclick="return confirm('Estás seguro que deseas eliminar el registro?');" href="../vista/mascotas/borrar?id=<?php echo $va["id_pet"]; ?>"  class="btn bg-red btn-circle waves-effect waves-circle waves-float">
