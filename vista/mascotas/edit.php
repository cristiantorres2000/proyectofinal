    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../panel-admin/administrador"> DASHBOARD </a>
            </div>
...
$con = connect();
$id = $_GET['id'];
$sql = "SELECT pet.id_pet, pet.nomas, pet_type.id_tiM, pet_type.noTiM, raza.id_raza, raza.nomraza, enfermedad.idenfermedad, enfermedad.nombreenfermedad, pet.sexo, pet.edad, pet.tamano, pet.peso, owner.id_due, owner.dni_due, owner.nom_due, owner.ape_due, owner.movil, owner.correo, owner.direc, pet.obser, pet.estado, pet.fere FROM pet INNER JOIN pet_type ON pet.id_tiM =  pet_type.id_tiM INNER JOIN raza ON pet.id_raza =raza.id_raza INNER JOIN enfermedad ON pet.idenfermedad=enfermedad.idenfermedad  INNER JOIN owner ON pet.id_due = owner.id_due  WHERE id_pet= '$id'";
$query  =$con->query($sql);
$data =  array();
if($query){
