                    ...
                    <div class="body">
                        <form method="POST"  autocomplete="off" enctype="multipart/form-data">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <label class="control-label">Enfermedad<span class="text-danger">*</span></label>
                                    <select name="idenfermedad" class="form-control show-tick" onchange="showselect(this.value)">
                                        
                                        <option value="" >-- Seleccione un tipo --</option>
                                        <?php include "../funciones/tipoenfermedad.php" ?>
                                    </select>
                                </div>
...
$sql2 = "insert into pet(nomas,id_tiM,id_raza,idenfermedad,sexo,edad,tamano,peso,id_due,obser,estado) 
values ('$nomas','$id_tiM','$id_raza','$idenfermedad','$sexo','$edad','$tamano','$peso','$id_due','$obser','$estado')";
